  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message === 'Invalid login credentials'
        ...
        ? 'E-mail não confirmado. Verifique sua caixa de entrada ou entre em contato com o suporte.'
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-white/[0.05] hover:bg-white/[0.08] border border-white/[0.10] hover:border-white/[0.18] text-white text-sm font-semibold rounded-xl px-4 py-3 transition-all duration-200 mb-4 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loadingGoogle ? (
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[#444] text-xs uppercase tracking-wider">ou</span>
                <div className="flex-1 h-px bg-white/[0.06]" />
              </div>
